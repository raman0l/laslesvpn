    ...
    <>
      <div className="max-w-[1220px] xl:px-[40px] lg:px-[30px] md:px-[20px] px-[16px] mx-auto">
        <div className="flex items-center justify-between lg:mt-[45px] md:mt-[30px] mt-[20px]">
          <Link
            href={"/"}
            className="lg:max-w-[149px] md:max-w-[120px] max-w-[100px]"
          >
            {" "}
            <Image
              width={149}
          ...
          <div className="flex gap-1 max-[600px]:hidden">
            ...
            <button className="text-[#F53855] lg:text-base md:text-sm text-xs font-medium lg:p-[13px_45px] md:p-[10px_30px] p-[8px_15px] border-1 border-[#F53855] rounded-[50px] hover:bg-[#F53855] hover:text-white duration-500 ease-in-out">
              Sign In
            </button>
          </div>
